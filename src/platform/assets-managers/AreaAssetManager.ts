...
export default class AreaAssetManager {
    ...
    static async CreateAreaAsset(assetParams: CreateAssetParamas, uploadFileParams: UploadAssetFileParams) {
        ...
        await AssetsApi.UploadAssetData(createdAsset, createdAsset)
